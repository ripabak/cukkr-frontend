...
| onboarding-splash | brand-splash, onboarding-container | Brand splash before onboarding | [] | [] | - | ui-ux-pages-pngs/onboarding/ONBOARD.png | No page route exists; only onboarding primitives are present. |
| onboarding-easy-booking | onboarding-container, onboarding-card, onboarding-indicator, onboarding-button | First onboarding benefit slide | [] | [] | - | ui-ux-pages-pngs/onboarding/ONBOARD 1.png | Index links reference onboarding pages, but actual route files are missing. |
| onboarding-run-barbershop | onboarding-container, onboarding-card, onboarding-indicator, onboarding-button | Second onboarding benefit slide | [] | [] | - | ui-ux-pages-pngs/onboarding/ONBOARD 4.png | Build after shared onboarding container is wired to routes. |
| onboarding-customer-happy | onboarding-container, onboarding-card, onboarding-indicator, onboarding-button | Final onboarding slide with get-started CTA | [] | [] | - | ui-ux-pages-pngs/onboarding/ONBOARD 5.png | Use the existing component set instead of creating a second onboarding layout. |
...
| brand-splash | - | Minimal centered launch brand presentation | [] | [] | - | ui-ux-pages-pngs/onboarding/ONBOARD.png | Could be implemented as a tiny route using existing theme primitives. |
...
| nama_halaman | dependency | kegunaan | slicing_implemented | functioning_api_implemented | lokasi | lokasi_referensi_png | implementation_notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| home-dashboard | workspace-pill, metric-card, shortcut-tile, bottom-tab-bar | Show workspace summary, KPIs, and recent activity | [] | [] | app/index.tsx (placeholder only) | ui-ux-pages-pngs/home/Home.png | Current index file is a navigation/debug screen, not the designed dashboard. |
| home-reset-walk-in-pin-modal | home-dashboard, confirmation-modal | Confirm walk-in PIN reset | [] | [] | - | ui-ux-pages-pngs/home/Home-reset-walkin-pin.png | Build on top of the real dashboard rather than the current placeholder index. |
| switch-barbershop | screen-header, selection-row, primary-button | Switch active workspace or create a new one | [] | [] | - | ui-ux-pages-pngs/home/Change Workspace.png | Should be implemented immediately after the dashboard shell. |
| create-barbershop-name-logo | wizard-progress, text-input-field, image-upload-box, primary-button | Start workspace-creation flow | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Fill name & logo.png | First step of the setup wizard. |
| create-barbershop-invite-barber-empty | wizard-progress, text-input-field, secondary-button, primary-button | Invite barbers during setup when no invites exist yet | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Invite Barber 2.png | Shares structure with the filled invite state. |
| create-barbershop-invite-barber-filled | wizard-progress, invite-row, secondary-button, primary-button | Show pending invites during setup | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Invite Barber.png | Reuse the invite list pattern later in barber management. |
| create-barbershop-first-service | wizard-progress, service-form, primary-button | Capture the first default service in setup | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Create first service.png | Reuse service form primitives with the later service module. |
| create-barbershop-success | success-state, gradient-button | Confirm workspace creation success | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Congrats.png | Distinct completion state with gradient CTA. |
| barbershop-settings | screen-header, info-row, operation-row, bottom-tab-bar, danger-button | Central hub for barbershop information and operations | [] | [] | - | ui-ux-pages-pngs/barbershop/Barbershop Settings.png | Best built once shell spacing and card styles are stable. |
| edit-barbershop-info-flow | edit-field-header, text-input-field, multiline-input-field, helper-copy | Edit name, description, and address | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Barbershop Name.png; ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Barbershop Description.png; ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Barbershop Address.png | Three field-specific screens share one editing shell. |
| edit-booking-url | edit-field-header, prefixed-input-field, helper-copy, alert-modal | Edit public booking slug and handle unavailable-state feedback | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Book Url.png; ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Book Url-1.png | Inline validation plus blocking availability modal. |

### Components

| nama_komponen | dependency | kegunaan | slicing_implemented | functioning_api_implemented | lokasi | lokasi_referensi_png | implementation_notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| screen-header | - | Shared top bar with back icon and optional trailing action | [] | [] | - | ui-ux-pages-pngs/home/Change Workspace.png | Needed by most post-auth pages; build once and reuse everywhere. |
| bottom-tab-bar | - | Shared bottom navigation for post-auth app shell | [] | [] | - | ui-ux-pages-pngs/home/Home.png | High-priority app-shell primitive. |
| workspace-pill | - | Dropdown-like current workspace selector | [] | [] | - | ui-ux-pages-pngs/home/Home.png | Reusable for dashboard and date/workspace controls. |
| metric-card | - | KPI card for counts, links, or PIN summary | [] | [] | - | ui-ux-pages-pngs/home/Home.png | Useful for dashboard and customer stats. |
| shortcut-tile | - | Icon + label quick access tile | [] | [] | - | ui-ux-pages-pngs/home/Home.png | Shared module launcher row. |
| wizard-progress | - | Multi-step progress bar for setup | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Fill name & logo.png | Needed across the three-step barbershop creation flow. |
| image-upload-box | - | Dashed or filled media upload surface | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Fill name & logo.png | Shared by setup, service form, and profile pages. |
| text-input-field | - | Shared single-line text, numeric, and currency input | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Create first service.png | Core shared form primitive outside auth. |
| multiline-input-field | text-input-field | Shared long-form input | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Barbershop Description.png | Reuse for descriptions, bio, and messages. |
| info-row | - | Shared label-value row for detail summaries | [] | [] | - | ui-ux-pages-pngs/barbershop/Barbershop Settings.png | High-value shared detail pattern. |
| operation-row | info-row | Chevron row that navigates to submodules | [] | [] | - | ui-ux-pages-pngs/barbershop/Barbershop Settings.png | Thin variant of info-row with navigation affordance. |
| selection-row | - | Simple avatar/text row with chevron for choosing one item | [] | [] | - | ui-ux-pages-pngs/home/Change Workspace.png | Reused by switch workspace and picker screens. |
| confirmation-modal | - | Shared two-action confirmation dialog | [] | [] | - | ui-ux-pages-pngs/home/Home-reset-walkin-pin.png | Needed widely; build once early. |
| alert-modal | - | Shared single-action blocking or success feedback dialog | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Book Url-1.png | Reusable for URL errors and profile success notices. |
| helper-copy | - | Short instructional copy block under inputs | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Barbershop Name.png | Keep this pattern consistent across edit forms. |
| edit-field-header | screen-header | Shared shell for field-specific edit screens with save action | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Barbershop Name.png | Reuse for shop info, profile edits, and service field edits. |
| prefixed-input-field | text-input-field | Input with fixed prefix like booking URL domain | [] | [] | - | ui-ux-pages-pngs/barbershop/barbershop-information/Input Text Book Url.png | Needed specifically for the booking URL editor. |
| invite-row | - | Pending invite row with remove affordance | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Invite Barber.png | Reuse in barber-management invite states. |
| success-state | - | Minimal success summary block | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Congrats.png | Good reusable completion pattern for future flows. |
| gradient-button | primary-button | CTA with gradient fill and trailing icon | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Congrats.png | Only needed after shared primary button metrics are settled. |
| danger-button | primary-button | Destructive CTA treatment | [] | [] | - | ui-ux-pages-pngs/barbershop/Barbershop Settings.png | Reuse for delete/cancel destructive actions. |
...
| primary-button | - | Shared pill CTA for non-auth pages | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Fill name & logo.png | Needed before most post-auth screens can be finished. |
| secondary-button | primary-button | Shared outline CTA | [] | [] | - | ui-ux-pages-pngs/create-barbershop/Invite Barber 2.png | Use in invites and verification flows. |
