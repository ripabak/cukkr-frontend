...
import { StatusFilterMenu, HISTORY_STATUS_OPTIONS } from '@/src/components/StatusFilterMenu';
...
const MOCK_HISTORY: HistoryBooking[] = [
  { id: '1', customerName: 'James Comberan', barberName: 'Pepe Julian', dateTimeLabel: '11 May 2025 8:30', duration: '30 mins', status: 'completed' },
  { id: '2', customerName: 'Liam Walker', barberName: 'Pepe Julian', dateTimeLabel: '11 May 2025 8:30', duration: '30 mins', status: 'completed' },
  { id: '3', customerName: 'Ethan James', barberName: 'Pepe Julian', dateTimeLabel: '11 May 2025 8:30', duration: '30 mins', status: 'waiting' },
  { id: '4', customerName: 'Ethan James', barberName: 'Pepe Julian', dateTimeLabel: '11 May 2025 8:30', duration: '30 mins', status: 'in-progress' },
];
          ...
          <View style={styles.list}>
            {filteredHistory.map((booking, i) => (
              <HistoryBookingRow
                ...
                style={i < filteredHistory.length - 1 ? styles.rowMargin : undefined}
              />
            ))}
          </View>
        </ScrollView>
