...
export const AppTheme = {
  ...
  typography: {
    heading: { fontSize: 30, fontWeight: "600" as const, fontFamily: "PlusJakartaSans_700Bold" as const, lineHeight: 36 },
    subheading: { fontSize: 22, fontWeight: "600" as const, fontFamily: "PlusJakartaSans_700Bold" as const, lineHeight: 28 },
